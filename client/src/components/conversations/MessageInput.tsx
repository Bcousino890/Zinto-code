...
export default function MessageInput({ conversationId, conversation, contact }: MessageInputProps) {
  ...
  return (
    <div className="flex-shrink-0 bg-background border-t border-border p-4 pb-[max(1rem,env(safe-area-inset-bottom))] transition-colors duration-200">
        ...
        <>
          <div className="relative flex items-center bg-background border border-border rounded-full px-4 py-3 shadow-sm hover:shadow-md transition-shadow duration-200">
            ...
            <button
              ...
              disabled={isAiStreaming || !tiktokCanReply}
              ...
              <div className="flex items-center gap-2">
                ...
                <button
                  className={`
                    ...
                    flex-shrink-0
                    ${isSending || isAiStreaming || !tiktokCanReply
                  ...
                  disabled={isSending || isAiStreaming || !tiktokCanReply}
                ...
                <button
                  className={`
                    ...
                    text-white focus-ring
                    flex-shrink-0
                    ${!isSending && !isAiStreaming && message.trim() && tiktokCanReply ? 'send-button-pulse' : ''}
                  `}
                  onClick={handleSendMessage}
                  disabled={isSending || isAiStreaming || !message.trim() || !tiktokCanReply}
          ...
          <div className="flex items-center justify-between mt-3">
            <div className="flex items-center space-x-1">
              ...
              {!isAiStreaming && conversation?.channelType === 'whatsapp_official' && (
