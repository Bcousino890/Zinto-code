        ...
        {isTimezonePending ? (
          ...
          <>
            ...
            <div className="flex justify-end">
              <Button onClick={handleSave} disabled={isSaving || saveTimezoneMutation.isPending}>
                  ...
                  {autoAddToPipeline ? (
                    <div className="mt-4 space-y-3">
                      <div className="space-y-2">
                        ...
                        >
                          <SelectTrigger id="auto-add-pipeline-select" className="w-full max-w-sm">
                            <SelectValue
                      ...
                      <div className="space-y-2">
                        ...
                        >
                          <SelectTrigger id="auto-add-stage-select" className="w-full max-w-sm">
                            <SelectValue
    ...
    <div className="flex flex-1 min-h-0 flex flex-col overflow-hidden font-sans text-foreground">
      ...
      <div className="flex flex-1 overflow-hidden min-h-0">
        <div className="flex-1 overflow-y-auto p-3 sm:p-6">
          <div className="flex flex-col sm:flex-row sm:items-center justify-between mb-6 gap-4">
            <div>
              <h1 className="text-2xl">{t('settings.page.title', 'Settings')}</h1>
          ...
          <Dialog open={showQrModal} onOpenChange={(open) => {
            ...
            <DialogContent className="sm:max-w-[500px]" closeOnOutsideClick={false}>
              <DialogHeader>
                <DialogTitle>
      ...
      <InstagramConnectionForm
          ...
          <Tabs value={activeTab} onValueChange={setActiveTab}>
            <div className="mb-6">
              <ScrollableTabs>
                <TabsList className="inline-flex h-10 items-center justify-start rounded-md bg-muted p-1 text-muted-foreground min-w-max gap-1 flex-nowrap">
                  ...
                  <TabsTrigger value="pipeline" className="text-xs sm:text-sm whitespace-nowrap px-2 sm:px-3 flex-shrink-0">
                  ...
                  {(currentUser?.role === 'admin' || currentUser?.isSuperAdmin) && (
                    <TabsTrigger value="email-settings" className="text-xs sm:text-sm whitespace-nowrap px-2 sm:px-3 flex-shrink-0">
                      {t('settings.tabs.email', 'Email')}
                    </TabsTrigger>
                  )}
                  {(currentUser?.role === 'admin' || currentUser?.isSuperAdmin) && (
                    <TabsTrigger value="contact-custom-fields" className="text-xs sm:text-sm whitespace-nowrap px-2 sm:px-3 flex-shrink-0">
                  ...
                  {(currentUser?.role === 'admin' || currentUser?.isSuperAdmin) && (
                    <TabsTrigger value="custom-js" className="text-xs sm:text-sm whitespace-nowrap px-2 sm:px-3 flex-shrink-0">
            ...
            {(currentUser?.role === 'admin' || currentUser?.isSuperAdmin) && (
              <TabsContent value="contact-custom-fields">
