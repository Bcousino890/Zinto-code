...
import { Star, StarOff, Download, Copy, Play, Pause, Bot, User, Clock, TrendingUp, AlertCircle, FileText, BarChart3, Database } from 'lucide-react';
  ...
  const { data: call, isLoading, isError, error, refetch } = useQuery({
    ...
    refetchInterval: (query): number | false => {
      ...
      const awaitingTwilio =
        ...
        c.recordingExpectedFrom === 'twilio' &&
        !c.recordingUrl &&
        terminal;
      ...
      <DialogContent className="max-w-4xl max-h-[90vh] overflow-y-auto">
        ...
        <Tabs value={activeTab} onValueChange={setActiveTab}>
          <TabsList>
            ...
            {isElevenLabsCall && (
              <TabsTrigger value="analysis">{t('call_logs.analysis', 'Analysis')}</TabsTrigger>
            )}
