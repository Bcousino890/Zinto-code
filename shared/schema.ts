...
export const apiKeys = pgTable("api_keys", {
  ...
  rateLimitPerMinute: integer("rate_limit_per_minute").default(300),
  rateLimitPerHour: integer("rate_limit_per_hour").default(5000),
  rateLimitPerDay: integer("rate_limit_per_day").default(50000),
