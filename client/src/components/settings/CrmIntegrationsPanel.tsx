...
import { Check, Copy, Edit3, Link2, Loader2, Plus, RefreshCw, RotateCcw, ShieldCheck, Trash2, XCircle } from 'lucide-react';
...
const FALLBACKS = {
  ...
  rotateSecret: 'Regenerar secreto', rotateSecretTitle: 'Regenerar secreto del webhook', rotateSecretDescription: 'El secreto actual dejará de funcionar inmediatamente. Copia el nuevo secreto y actualiza tu CRM.',
