...
export default function MessageBubble({ message, contact, channelType, onReply, onQuotedMessageClick, conversation, reactions = [] }: MessageBubbleProps) {
  ...
  const renderMessageContent = () => {
    ...
    const forceInlineRender = userRequestedInlineMediaLoad || persistedInlineMediaLoad || Boolean((message as any)?.forceInlineMediaLoaded) || Boolean((message as any)?.mediaUrlFetchedAt);
