      ...
      <Card>
        <CardHeader>
          <div className="flex items-center gap-2">
            ...
            <CardTitle>{t('settings.whatsapp.message_debouncing', 'Buffered Replies')}</CardTitle>
          </div>
          <CardDescription>
        ...
        <CardContent className="space-y-6">
          <div className="flex items-center justify-between">
            <div className="space-y-0.5">
              <Label className="text-base">{t('settings.whatsapp.enable_debouncing', 'Enable Buffered Replies')}</Label>
              <div className="text-sm text-muted-foreground">
                {t('settings.whatsapp.enable_debouncing_desc', 'Buffer rapid inbound messages and reply once the user pauses')}
              </div>
            </div>
            <Switch
